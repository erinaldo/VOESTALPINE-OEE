...
Imports System.IO
Public Class frm_REPORT_AMARRADO
    Private Sub frm_REPORT_AMARRADO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        rv_REPORT.LocalReport.ReportEmbeddedResource = "MCONTROL_OEE.report_AMARRADO.rdlc"
        ...
        cmdRead = "SELECT * FROM [dbo].[exe_MCONTROL_OEE_report_amarrado] WHERE [userid] = " & intUSERID & " ORDER BY [data_recebido]"
