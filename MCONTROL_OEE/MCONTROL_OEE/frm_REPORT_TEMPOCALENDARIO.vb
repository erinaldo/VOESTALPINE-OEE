...
Imports System.IO
Public Class frm_REPORT_TEMPOCALENDARIO
    Private Sub frm_REPORT_TEMPOCALENDARIO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        rv_REPORT.LocalReport.ReportEmbeddedResource = "MCONTROL_OEE.report_TEMPOCALENDARIO.rdlc"
        ...
        cmdRead = "SELECT * FROM [dbo].[exe_MCONTROL_OEE_report_tempocalendario] WHERE [userid] = " & intUSERID
