...
Imports System.IO
Public Class frm_REPORT_APONTAMENTO_LIVRE
    Private Sub frm_REPORT_APONTAMENTO_LIVRE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        rv_REPORT.LocalReport.ReportEmbeddedResource = "MCONTROL_OEE.report_APONTAMENTO_LIVRE.rdlc"
        ...
        cmdRead = "SELECT * FROM [dbo].[exe_MCONTROL_OEE_report_apontamento_livre] WHERE [userid] = " & intUSERID
