...
pt.depdownload_msg=Os seguintes aplicativos são necessários para que a instalação possa continuar:%n%n%1%nBaixar e Instalar agora?

en.depdownload_memo_title=Download dependencies
de.depdownload_memo_title=Abhängigkeiten downloaden
pt.depdownload_memo_title=Download dendependencias

en.depinstall_memo_title=Install dependencies
de.depinstall_memo_title=Abhängigkeiten installieren
pt.depinstall_memo_title=Instalar dependencias

en.depinstall_title=Installing dependencies
de.depinstall_title=Installiere Abhängigkeiten
pt.depinstall_title=Instalando dependencias

en.depinstall_description=Please wait while Setup installs dependencies on your computer.
de.depinstall_description=Warten Sie bitte während Abhängigkeiten auf Ihrem Computer installiert wird.
pt.depinstall_description=Por favor aguarde enqaunto o Setup instala as dependencias no seu computador.

en.depinstall_status=Installing %1...
de.depinstall_status=Installiere %1...
pt.depinstall_status=Instalando %1...
...
pt.depinstall_missing=%1 deve set instalado antes que o Seetup possa continuar. Por favor instale %1 e execute o Setup novamente.
...
pt.depinstall_error=Um erro ocorreu enquanto instalava-se as dependencias. Por favor reinicie o computador e execute o Setup novamente ou instale a seguinte dependencia manualmente:%n
 

en.isxdl_langfile=
de.isxdl_langfile=german2.ini
pt.isxdl_langfile=portugues.ini

[Files]
Source: "scripts\isxdl\german2.ini"; Flags: dontcopy
Source: "scripts\isxdl\portugues.ini"; Flags: dontcopy
